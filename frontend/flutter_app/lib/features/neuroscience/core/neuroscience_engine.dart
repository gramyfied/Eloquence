...
class NeuroscienceEngine {
  ...
  Future<void> processUserAction(UserAction action) async {
    try {
      ...
      rewardSystem.generateReward(context, userModelManager.getCurrentPerformance());
      feedbackLoop.createFeedbackLoop(action, context);
      ...
      final engagementData = UserEngagementData(
        behavioralData: BehavioralData(
          ...
          exerciseData: const [],
          featureUsage: const {},
          socialInteractions: const [],
        ),
        emotionalData: const EmotionalData(
        ...
        cognitiveData: const CognitiveData(
          attentionLevel: 0.8,

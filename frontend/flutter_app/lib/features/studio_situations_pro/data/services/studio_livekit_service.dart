...
// TODO: Replace with actual server URL and token generation logic
...
class StudioLiveKitService {
  ...
  /// Génère un token d'authentification (simulé pour le développement)
  Future<String> _generateToken(String roomName, String userId) async {
    // TODO: Appeler votre backend pour générer un vrai token
    // Pour le développement, utiliser un token de test
    return 'your-generated-token-$roomName-$userId';
  }

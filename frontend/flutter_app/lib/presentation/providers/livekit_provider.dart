...
class LiveKitConnectionNotifier extends StateNotifier<LiveKitConnectionState> {
  ...
  final CleanLiveKitService _liveKitService;
  ...
  Future<bool> connect(String roomName, String participantIdentity) async {
    ...
    try {
      ...
      final success = await _liveKitService.connect(roomName, participantIdentity);

        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              // Audio visualization - Commenté car le widget a été supprimé
              ...
              //   showReflection: true,
              // ),
              const SizedBox(height: 150, child: Center(child: Text('Visualiseur audio désactivé', style: TextStyle(color: Colors.white)))), // Placeholder
              const SizedBox(height: 40),
